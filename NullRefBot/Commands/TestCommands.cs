...
namespace NullRefBot.Commands
{
  public class TestCommands : BaseCommandModule {
    ...
    static String[] RonSwansonQuotes = new[] {
    ...
    public async Task Ron(CommandContext ctx) {
      ...
      embed.Description = RonSwansonQuotes[Environment.TickCount % RonSwansonQuotes.Length];
      embed.ThumbnailUrl = "https://uproxx.files.wordpress.com/2016/06/ron-swanson-feature.jpg?quality=95&w=650&h=360";
      embed.Footer = new DiscordEmbedBuilder.EmbedFooter();
      embed.Footer.Text = " - Ron Swanson";
